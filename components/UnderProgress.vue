<template>
      <section>
    <div class="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 lg:px-8 border-2 border-red-600">
      ...
      /> -->
        ...
        <div class="bg-gray-300 p-8 md:p-12 lg:px-16 lg:py-24">
          <div class="mx-auto max-w-xl text-center">
            <h2 class="text-2xl font-bold text-black md:text-3xl">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit
            </h2>

            <p class="hidden text-black/90 sm:mt-4 sm:block">
          ...
          >
            Download report
              ...
              <NuxtLink to="/more"
                class="inline-block rounded-lg px-4 py-1.5 text-base font-semibold leading-7 text-gray-900 ring-1 ring-black/10 hover:ring-white hover:text-gray-800">
                Read More
